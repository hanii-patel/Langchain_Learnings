...
- **Structured Outputs:** Forcing the LLM to return strictly formatted data using Python's `TypedDict` and `Pydantic` models (`typeddict_demo.py`, `with_structured_output_typeddict.py`).
